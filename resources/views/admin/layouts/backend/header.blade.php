                ...
                <div class="d-flex align-items-center">
                            ...
                            <div class="search-items-wrapper">
                                ...
                                <div class="file-result px-4 py-2">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-image bg-gray-200 rounded">
                                                <img src="{{ asset('public/assets/images/file-icons/css.png')}}" alt="" class="img-fluid" />
                                            </div>
                                            <div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-image bg-gray-200 rounded">
                                                <img src="{{ asset('public/assets/images/file-icons/zip.png')}}" alt="" class="img-fluid" />
                                            </div>
                                            <div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-0">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar-image bg-gray-200 rounded">
                                                <img src="{{ asset('public/assets/images/file-icons/pdf.png')}}" alt="" class="img-fluid" />
                                            </div>
                                            <div>
                    ...
                    <div class="dropdown nxl-h-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-notifications-menu">
                            ...
                            <div class="notifications-item">
                                <img src="{{ asset('public/assets/images/avatar/3.png')}}" alt="" class="rounded me-3 border" />
                                <div class="notifications-desc">
                            ...
                            <div class="notifications-item">
                                <img src="{{ asset('public/assets/images/avatar/4.png')}}" alt="" class="rounded me-3 border" />
                                <div class="notifications-desc">
                            ...
                            <div class="dropdown-header">
                                <div class="d-flex align-items-center">
                                    ...
                                    @if(Auth::check())
                                        ...
                                        @else
                                            <img src="/default-avatar.png" alt="default-avatar" class="img-fluid user-avatar" />
                                        @endif
            ...
            <div class="modal-body">
                <form id="updateProfileForm" method="POST" action="{{ route('admin.profile.update') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control @error('avatar') is-invalid @enderror" id="avatar" name="avatar" value="{{ old('avatar', auth()->user()->avatar) }}" autocomplete="avatar">
                        @error('avatar')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
