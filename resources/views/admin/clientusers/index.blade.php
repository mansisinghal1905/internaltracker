            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Client Users</li>
                    </ul>
                </div>
                        ...
                        <div class="card stretch stretch-full">
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table class="table table-hover data-table1 table stripe hover nowrap" id="clientuserList">
                                        <thead>
                                            <tr>
                                                <th class="wd-30">
...
<script type="text/javascript">
		$(function () {
			...
			// 	alert(id);
			// });
			var table = $('#clientuserList').DataTable({
				processing: true,
				serverSide: true,
				...
				ajax: {
					url: "{{ route('admin.clientuserAjax') }}",
					type: "POST",
					data: {
                        status: $('input[name=status]').val(),
						search: $('input[name=client_name]').val(),
			...
			// for chnage status
            $(document).on('change', '.clientuserStatusToggle', function () {
                var id = $(this).attr("data-id");
                var status = $(this).is(':checked') ? 1 : 0;

                $.ajax({
                    type: "POST",
                    url: @json(route('admin.ChangeClientUserStatus')),
        ...
        function deleteClientUsers(element) {
