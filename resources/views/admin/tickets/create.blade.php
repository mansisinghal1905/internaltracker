                                    ...
                                    <form action="{{ $ticket ? route('admin.ticket-system.update', $ticket->id) : route('admin.ticket-system.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="{{ Auth::user()->id }}" class="form-control" value="{{ Auth::user()->first_name }} {{ Auth::user()->last_name }}" id="displayNameInput" placeholder="Customer Name" readonly>
                                            </div>
                                        </div>
                                                ...
                                                <select class="form-control" data-select2-selector="tag" name="user_id" id="user_id">
                                                    @if(count($users) > 0)
                                                        ...
                                                        @foreach($users as $user)
                                                            <option value="{{ $user->id }}" @if(isset($ticket) && $ticket->user_id == $user->id) selected @endif>{{ ucfirst($user->first_name) }} {{ ucfirst($user->last_name) }}</option>
                                                        @endforeach
                                                    @else
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-control @error('department') is-invalid @enderror" data-select2-selector="tag" name="department" id="">
                                                            ...
                                                            <option value="2" {{ old('department', isset($ticket->department) ? $ticket->department : '') == '2' ? 'selected' : '' }}>Account</option>
                                                            <option value="3" {{ old('department', isset($ticket->department) ? $ticket->department : '') == '3' ? 'selected' : '' }}>Billing</option>
                                                            <option value="4" {{ old('department', isset($ticket->department) ? $ticket->department : '') == '4' ? 'selected' : '' }}>Technical</option>
                                                    </select>
                                                </div>
                                                @error('department')
                                                    <span class="text-danger">{{ $message }}</span>
