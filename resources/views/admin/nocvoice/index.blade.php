            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">NOC Voice</li>
                    </ul>
                </div>
                        ...
                        <div class="card stretch stretch-full">
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table class="table table-hover data-table1 table stripe hover nowrap" id="nocvoiceList">
                                        <thead>
                                            <tr>
                                                <th class="wd-30">
                                                   S.No.
...
<script type="text/javascript">
		$(function () {
			...
			// 	alert(id);
			// });
			var table = $('#nocvoiceList').DataTable({
				processing: true,
				serverSide: true,
