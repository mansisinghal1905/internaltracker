            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Quotation Mail</h5>
                    </div>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('admin.sendpurposal.index') }}">Home</a></li>
                        <li class="breadcrumb-item">Quotation Mail</li>
                    </ul>
                </div>
                <div class="page-header-right ms-auto">
                    <div class="page-header-right-items">
                        ...
                        <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                            ...
                            <a href="{{ route('admin.sendpurposal.create') }}" class="btn btn-primary">
                                <i class="feather-plus me-2"></i>
                                <span>Create Quotation Mail</span>
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="card stretch stretch-full">
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table class="table table-hover data-table1 table stripe hover nowrap" id="sendpurposalList">
                                        <thead>
                                            <tr>
                                                <th class="wd-30">
...
<script type="text/javascript">
		$(function () {
			...
			var table = $('#sendpurposalList').DataTable({
				processing: true,
				serverSide: true,
				...
				ajax: {
					url: "{{ route('admin.sendpurposalAjax') }}",
					type: "POST",
					data: {
