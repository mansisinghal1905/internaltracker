            ...
            <div class="minimal-card-wrapper">
                <div class="card mb-4 mt-5 mx-4 mx-sm-0 position-relative">
                    ...
                    <div class="card-body p-sm-5">
                        ...
                        <form action="{{ route('login.custom') }}" method="post" class="w-100 mt-4 pt-2">
                        @csrf    
                            <!-- @if (session('status'))
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div>
                                    <a href="{{route('admin.forgotPassword')}}" class="fs-11 text-primary">Forget password?</a>
                                </div>
                            </div>
                            <div class="mt-5">
                        ...
                        <div class="mt-5 text-muted">
                            ...
                            <a href="{{ route('register-user') }}" class="fw-bold">Create an Account</a>
                        </div>
                    </div>
                </div>
            </div>
